...
def main(opts):
    ...
    logger = TrainingLogger(run_folder, ats_model, test_dataset, project="mega_mnist",
...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", type=int, default=4000, help="How many epochs to train for")
    parser.add_argument("--decrease_lr_at", type=float, default=2000, help="Decrease the learning rate in this epoch")
    ...
    parser.add_argument("--saving_epoch", type=int, default=250, help="How many epochs between each save")
    parser.add_argument("--make_images_every", type=int, default=50, help="How many epochs between each image log")
